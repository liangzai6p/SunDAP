...
//	private static HashMap<String, String> charMap = new HashMap<String, String>();
    ...
    public static List<String> currentYearWeekDateList(int currentYear){
        ...
        try{
            log.debug("currentYearWeekDateList-Start");
  			/*//获取当前年日历实例
            ...
            log.debug("currentYearWeekDateList-End");
        }catch(Exception e){
            log.error("currentYearWeekDateList获取本年全部周末日期数组异常",e);
        }
        return weekList;
    }
