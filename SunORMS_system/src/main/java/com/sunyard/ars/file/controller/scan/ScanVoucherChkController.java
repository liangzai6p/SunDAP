 ...
 * 
 * @date   2018年5月24日
 * @Description 影像采集Controller
 */
@Controller
public class ScanVoucherChkController extends BaseController {
	
	@Resource
	private IVoucherChkService voucherChkService;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/scanVoucherChk.do", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
	@ResponseBody
	...
	protected ResponseBean doAction(HttpServletRequest req, RequestBean requestBean, ResponseBean responseBean) {
		try {			
			responseBean = voucherChkService.execute(requestBean);
		} catch (Exception e) {
