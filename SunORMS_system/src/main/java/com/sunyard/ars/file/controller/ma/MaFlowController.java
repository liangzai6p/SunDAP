 ...
 */
@Controller
public class MaFlowController extends BaseController {

	// 服务接口
	@Resource
	private IMaFlowService maFlowService;
	...
	protected ResponseBean doAction(HttpServletRequest request, RequestBean requestBean, ResponseBean responseBean) {
		try {			
			responseBean = maFlowService.execute(requestBean);
		} catch (Exception e) {
