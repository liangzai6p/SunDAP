...
public class HomePageController extends BaseController {
	...
	@RequestMapping(value = "/homePageController.do", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
	@ResponseBody
	@ArchivesLog(operationType="增删改查", operationName="操作主页信息")
	...
	protected ResponseBean doAction(HttpServletRequest request, RequestBean requestBean, ResponseBean responseBean) {
		try {			
			responseBean = homePageService.execute(requestBean);
		} catch (Exception e) {
